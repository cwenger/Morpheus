...
xcopy "Morpheus\Morpheus (command line)\bin\Agilent\32-bit\Release\*" /EXCLUDE:exclude.txt "release\Morpheus (Agilent 32-bit)"
...
xcopy "Morpheus\Morpheus (command line)\bin\Agilent\64-bit\Release\*" /EXCLUDE:exclude.txt "release\Morpheus (Agilent 64-bit)"
