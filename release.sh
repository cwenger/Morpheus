...
rsync -a --exclude=*.mdb "Morpheus/mzML/MonoDevelop/bin/Release/." "release/revision $revision/Morpheus (Linux)"
rsync -a --exclude=*.mdb "Morpheus/mzML/MonoDevelop/command line/bin/Release/." "release/revision $revision/Morpheus (Linux)"
